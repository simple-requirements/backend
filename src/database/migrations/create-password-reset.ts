    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable(
            new Table({
                ...
                uniques: [{ name: 'UQ_password_reset_tokens_token_hash', columnNames: ['token_hash'] }],
                foreignKeys: [
                    {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                indices: [
                    { name: 'IDX_password_reset_attempts_source_created', columnNames: ['source_hash', 'created_at'] },
                ],
            }),
            true,
        );
