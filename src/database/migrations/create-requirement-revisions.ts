        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'implementation_tickets', type: 'jsonb', default: "'[]'::jsonb" },
                    { name: 'created_at', type: 'timestamptz', isNullable: false },
                    { name: 'updated_at', type: 'timestamptz', isNullable: false },
                ],
                indices: [
                    { name: 'IDX_requirement_revisions_requirement_id', columnNames: ['requirement_id'] },
                    { name: 'IDX_requirement_revisions_project_id', columnNames: ['project_id'] },
                ],
                uniques: [
                    {
                ...
                checks: [
                    ...
                    { name: 'CHK_requirement_revisions_revision_number_range', expression: '"revision_number" > 0' },
                    {
