        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'status', type: 'varchar', length: '12', default: "'draft'", isNullable: false },
                    ...
                    { name: 'reviewer', type: 'varchar', length: '120', isNullable: true },
                ...
                indices: [
                    ...
                    { name: 'IDX_requirements_category_id', columnNames: ['category_id'] },
                    { name: 'IDX_requirements_deleted_at', columnNames: ['deleted_at'] },
                ],
                uniques: [
                    { name: 'UQ_requirements_project_key', columnNames: ['project_id', 'key'] },
                    { name: 'UQ_requirements_category_sequence', columnNames: ['category_id', 'sequence_number'] },
                ],
                checks: [
                    {
                    ...
                    { name: 'CHK_requirements_revision_number_range', expression: '"revision_number" > 0' },
                    { name: 'CHK_requirements_priority', expression: `"priority" IS NULL OR "priority" IN ('p1', 'p2', 'p3')` },
                    { name: 'CHK_requirements_key_format', expression: `"key" ~ '^(FR|NFR)-[A-Z]{2,4}-[0-9]{4}$'` },
                ],
                foreignKeys: [
                    {
