        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'normalized_username', type: 'varchar', length: '64', isUnique: true },
                    { name: 'email', type: 'varchar', length: '320' },
                    { name: 'normalized_email', type: 'varchar', length: '320', isUnique: true },
                ...
                checks: [{ name: 'CHK_users_status', expression: `"status" IN ('pending', 'active', 'deactivated')` }],
            }),
            true,
        );
    }
