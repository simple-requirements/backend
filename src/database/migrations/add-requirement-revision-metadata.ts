...
function metadataColumns(): TableColumn[] {
    return [
        ...
        new TableColumn({ name: 'changed_at', type: 'timestamptz', isNullable: false, default: 'now()' }),
        new TableColumn({ name: 'changed_by_user_id', type: 'uuid', isNullable: true }),
        new TableColumn({
...
export class AddRequirementRevisionMetadata1789210000000 implements MigrationInterface {
