    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable(
            new Table({
                ...
                indices: [
                    { name: 'UQ_authentication_sessions_token_hash', columnNames: ['token_hash'], isUnique: true },
                    { name: 'IDX_authentication_sessions_user_activity', columnNames: ['user_id', 'last_activity_at'] },
                ],
                foreignKeys: [
                    {
