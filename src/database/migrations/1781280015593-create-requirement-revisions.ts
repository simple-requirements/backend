...
export class CreateRequirementRevisions1781280015593 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "requirements_key_counters" DROP CONSTRAINT IF EXISTS "FK_requirements_categories"`,
        );
        await queryRunner.query(
            `ALTER TABLE "requirements_key_counters" DROP CONSTRAINT IF EXISTS "FK_requirements_key_counters_categories"`,
        );
        await queryRunner.query(`ALTER TABLE "requirements" DROP CONSTRAINT IF EXISTS "FK_requirements_categories"`);
        await queryRunner.query(
            `ALTER TABLE "requirements" DROP CONSTRAINT IF EXISTS "FK_requirements_type_matches_category"`,
        );
        await queryRunner.query(
