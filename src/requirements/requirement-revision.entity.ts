...
@Check('CHK_requirement_revisions_type', `"type" IN ('FR', 'NFR')`)
@Check('CHK_requirement_revisions_status', `"status" IN ('draft')`)
...
@Check('CHK_requirement_revisions_visible_key_format', `"visible_key" ~ '^(FR|NFR)-[A-Z]{3,4}-[0-9]{4}$'`)
