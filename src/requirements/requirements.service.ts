...
export class RequirementsService {
    ...
    async create(createRequirementDto: CreateRequirementDto): Promise<RequirementResponseDto> {
        ...
        requirement.title = createRequirementDto.title.trim();
    ...
    private validateCreateRequirementDto(createRequirementDto: CreateRequirementDto): void {
        ...
        if (!Object.values(RequirementType).includes(createRequirementDto.kind)) {
        ...
        this.validateRequiredString(createRequirementDto.title, 'Requirement title is required', 200);
