...
export class AdministratorProjectSummaryResponseDto {
    ...
    @ApiProperty({
        ...
        description: 'Category names exposed as administrative summary metadata. Category details are not included.',
        type: String,
        isArray: true,
    })
    ...
    @ApiProperty({
        ...
        isArray: true,
        description: 'Administrative category summaries with requirement counts; no requirement content is exposed.',
    })
