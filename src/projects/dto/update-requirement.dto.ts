...
export class UpdateRequirementDto {
    @ApiPropertyOptional({ example: '2d7f9e0c-8d9c-4a5f-a3d2-1a44a28e0d10', description: 'Owning category identifier.' })
    categoryId?: string;
    ...
    @ApiPropertyOptional({ enum: RequirementStatus, example: RequirementStatus.Approved })
