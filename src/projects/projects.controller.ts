...
export class ProjectsController {
    ...
    async findAll(@Req() request: AuthenticatedRequest): Promise<ProjectResponseDto[]> {
        const ids = await this.memberships.projectIdsForUser(request.authentication.user.id);
