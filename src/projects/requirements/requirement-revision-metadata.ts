...
export const systemRevisionActor: RequirementRevisionActor = { userId: null, displayName: 'System' };

export function revisionActorFromAuthenticatedUser(user: {
    readonly id: string;
    readonly displayName: string;
}): RequirementRevisionActor {
