...
describe('RequirementReviewsService', () => {
    ...
    beforeAll(async () => {
        ...
        reviewCommentsRepository = { count: vi.fn(), create: vi.fn(), find: vi.fn(), findOne: vi.fn(), save: vi.fn() };
    ...
    it('rejects replies to closed comments.', async () => {
        ...
        reviewCommentsRepository.findOne.mockResolvedValue(
            createReviewCommentEntity({ status: RequirementReviewCommentStatus.Closed }),
        );
