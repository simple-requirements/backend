...
export class RequirementReviewsController {
    ...
    async createReviewCommentReply(
        ...
        return this.requirementReviewsService.createReviewCommentReply(
            ...
            requirementId,
            commentId,
            Object.assign(createReplyDto, { author: request.authentication.user.displayName }),
        );
    }
    ...
    async closeReviewComment(
        ...
        return this.requirementReviewsService.closeReviewComment(
            ...
            requirementId,
            commentId,
            Object.assign(closeCommentDto, { closedBy: request.authentication.user.displayName }),
        );
    }
    ...
    async approveRequirement(
        ...
        return this.requirementReviewsService.approveRequirement(
            projectId,
            requirementId,
            Object.assign(approveRequirementDto, { reviewer: request.authentication.user.displayName }),
    ...
    async rejectRequirement(
        ...
        return this.requirementReviewsService.rejectRequirement(
            projectId,
            requirementId,
            Object.assign(rejectRequirementDto, { reviewer: request.authentication.user.displayName }),
            revisionActorFromAuthenticatedUser(request.authentication.user),
        );
    }
}
