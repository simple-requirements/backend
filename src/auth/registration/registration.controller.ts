...
export class RegistrationController {
    ...
    @ApiOperation({ operationId: 'registerUser', summary: 'Register a pending local user account.' })
    @ApiAcceptedResponse({ description: 'The registration request was accepted.', type: RegistrationResponseDto })
    @ApiBadRequestResponse({ description: 'The registration request is malformed.' })
    register(
    ...
    @ApiOperation({ operationId: 'confirmEmailVerification', summary: 'Confirm a local account email address.' })
    @ApiNoContentResponse({ description: 'The email address was verified.' })
    @ApiBadRequestResponse({ description: 'The verification link is invalid or expired.' })
    ...
    @HttpCode(HttpStatus.ACCEPTED)
    @ApiOperation({ operationId: 'resendEmailVerification', summary: 'Request another verification email.' })
    @ApiAcceptedResponse({
        description: 'The request was accepted without disclosing account eligibility.',
