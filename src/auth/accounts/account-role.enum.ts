...
export function isProjectAccountRole(role: AccountRole | null): role is ProjectAccountRole {
    return role !== null && PROJECT_ACCOUNT_ROLES.includes(role as ProjectAccountRole);
}
