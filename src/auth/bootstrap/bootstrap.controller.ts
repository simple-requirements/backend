...
export class BootstrapController {
    ...
    @ApiOperation({ operationId: 'bootstrapAdministrator', summary: 'Register the first local Administrator account.' })
    ...
    bootstrapAdministrator(
        ...
        return this.bootstrapService.registerAdministrator(registration, getRequestSource(request));
    }
}
