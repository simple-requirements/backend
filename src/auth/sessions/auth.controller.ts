...
export class AuthController {
    ...
    @ApiUnauthorizedResponse({ description: 'The credentials are invalid or the account is unavailable.' })
    login(
    ...
    async me(@Req() request: AuthenticatedRequest): Promise<AuthenticatedUserResponseDto> {
