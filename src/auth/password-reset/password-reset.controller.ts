...
import { confirmPasswordResetSchema, requestPasswordResetSchema } from '@/auth/dto/auth.schemas';
...
export class PasswordResetController {
    ...
    requestPasswordReset(
        ...
        return this.passwordResetService.request(dto.email, getRequestSource(request));
    }
